...
function show_options {
    ...
    echo "      -s            -- Skip redeployment of TripleO"
    exit $1
}
...
# TODO: Repeat ephermeral disk file creation/check
restart_demo_vm
...
# Attempt to ping the demo VM after the online upgrade attempt on the compute
# node
ping_demo_vm
